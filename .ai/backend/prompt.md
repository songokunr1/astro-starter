...
<implementation_plan>
@create-set-implementation-plan.md 
@update-set-implementation-plan.md 
@delete-set-implementation-plan.md 
</implementation_plan>
...
<tests>
create tests this endpoint ps1 script like @create-flashcard.ps1  simple similar. name it as enpoint test 
</tests>
